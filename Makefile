...
PROD_SERVICE_NAME = recipe-prod
PROD_CONTAINER_NAME = recipe-prod-container

PROFILE = dev
CONTAINER_NAME = recipe-dev-container
SERVICE_NAME = recipe-dev

DIRS_TO_VALIDATE = app
...
## docker-compose down
down:
	$(DOCKER_COMPOSE_COMMAND) --profile $(PROFILE) down
